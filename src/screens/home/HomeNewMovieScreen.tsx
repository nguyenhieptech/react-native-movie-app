...
type Props = NativeStackScreenProps<HomeStackParamList, 'HomeNewMovie'>;

export function HomeNewMovieScreen({ navigation }: Props) {
                ...
                <View className="flex-row items-center justify-between">
                  <View className="max-w-[65%]">
                    ...
                    <Text
                      ...
                      numberOfLines={3}
                    >
                      13-year-old Rafe does not think of life without drawing.
                      And when the director at the new school selects and
                      dissolves his notebook with drawings in acid, the guy
                      decides to take revenge. The school has stupid rules, and
                      Rafe will creatively break them one by one.
                    </Text>
                    <Text className="mt-1 text-xs text-white opacity-50">
                      2016, 92 minutes
                    </Text>
          ...
          <View className="h-100 w-full p-5">
            ...
            <View className="mb-8">
              <CustomButton
                text="Cancel"
                className="mb-2.5"
                onPress={() => setIsToShareModalVisible(false)}
              />
            </View>
          </View>
        </Modal>
